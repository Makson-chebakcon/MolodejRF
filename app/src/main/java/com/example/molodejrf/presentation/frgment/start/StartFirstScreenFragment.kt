 ...
 * Use the [StartFirstScreenFragment.newInstance] factory method to
...
class StartFirstScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment StartFirstScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StartFirstScreenFragment().apply {
